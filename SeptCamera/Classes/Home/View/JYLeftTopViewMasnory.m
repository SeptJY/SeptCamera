...
@interface JYLeftTopViewMasnory ()
...
@implementation JYLeftTopViewMasnory
...
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(leftTopSettingBtnOnClick)]) {
        [self.delegate leftTopSettingBtnOnClick];
    }
}
...
{
    __weak JYLeftTopViewMasnory *weakSelf = self;
